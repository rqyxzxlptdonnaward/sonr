...
replace (
	...
	// lyft/protoc-gen-validate moved to envoyproxy
	github.com/lyft/protoc-gen-validate => github.com/envoyproxy/protoc-gen-validate v1.0.0

	// pin version! 126854af5e6d has issues with the store so that queries fail
	github.com/syndtr/goleveldb => github.com/syndtr/goleveldb v1.0.1-0.20210819022825-2ae1ddf74ef7

	// tyler-smith/go-bip39 repository deleted - provide empty module stub in crypto/empty-module
...
require (
	...
	github.com/ipfs/kubo v0.38.1 // indirect
